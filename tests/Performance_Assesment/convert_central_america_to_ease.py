...
output_folder = '/home/beywood/ST/CIMR_RGB/CIMR-RGB/dpr/Test_cards/SCEPS_central_america/EASE_grids'
output_file_tag = 'SCEPS_central_america'
...
if __name__ == '__main__':
    # Open Data
    latitude, longitude, BTs = get_data(central_america_truth_scene, INCIDENCE_ANGLE)
