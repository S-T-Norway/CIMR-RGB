...
rsir_path = '/home/beywood/Desktop/MS4/optimal_params_data_dicts/rsir_c_9km_optimal_params.pkl'
bg_path = '/home/beywood/Desktop/MS4/optimal_params_data_dicts/bg_c_9km_optimal_params.pkl'
ids_path =  '/home/beywood/Desktop/MS4/optimal_params_data_dicts/ids_c_9km_optimal_params.pkl'
...
ids_grid = fit_to_ease(ids_dict['C']['bt_h'], ids_dict['C']['cell_row'], ids_dict['C']['cell_col'], GRIDS['EASE2_G9km'])
rsir_grid = fit_to_ease(rsir_dict['C']['bt_h'], rsir_dict['C']['cell_row'], rsir_dict['C']['cell_col'], GRIDS['EASE2_G9km'])
bg_grid = fit_to_ease(bg_dict['C']['bt_h'], bg_dict['C']['cell_row'], bg_dict['C']['cell_col'], GRIDS['EASE2_G9km'])

row_slice = slice(532, 579)
col_slice = slice(893, 959)
...
plt.suptitle('Optimal Regrid Comparison C_BAND BT_H (EASE2_G9km)', fontsize=16)
