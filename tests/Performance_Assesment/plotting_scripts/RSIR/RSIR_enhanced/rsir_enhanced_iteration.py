...
results_max_neighbours = '/home/beywood/ST/CIMR_RGB/CIMR-RGB/tests/Performance_Assesment/plotting_scripts/RSIR/RSIR_enhanced/RSIR_L_9km_rsir_iteration.csv'
...
# df_mrf_1 = band[band['max_neighbours'] == 4]
df_mrf_3 = band[band['max_neighbours'] == 150]
# df_mxn_3 = band[band['max_neighbours'] == 3]
# df_mxn_5 = band[band['max_neighbours'] == 5]
...
# df_mxn_3 = df_mxn_3.sort_values(by='rsir_iteration', ascending=True)
# df_mxn_5 = df_mxn_5.sort_values(by='rsir_iteration', ascending=True)
...
# ax1.plot(df_iter_1['rsir_iteration'], df_iter_1['mean_absolute_error'], label='max_neighbours=4')
ax1.plot(df_iter_3['rsir_iteration'], df_iter_3['mean_absolute_error'], label = 'max_neighbours=155')
ax1.scatter(df_iter_3['rsir_iteration'], df_iter_3['mean_absolute_error'], label = 'max_neighbours=155')
# ax1.plot(df_mxn_3['rsir_iteration'], df_mxn_3['mean_absolute_error'], label = 'max_neighbours=3')
# ax1.plot(df_mxn_5['rsir_iteration'], df_mxn_5['mean_absolute_error'], label = 'max_neighbours=5')
...
plt.title('RSIR L BAND rsir_iteration vs MAE & MAPE (EASE2_G36km)', fontsize=16)
plt.show()