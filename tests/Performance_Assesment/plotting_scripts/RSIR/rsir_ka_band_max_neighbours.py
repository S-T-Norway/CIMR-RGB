...
results_max_neighbours = '/home/beywood/ST/CIMR_RGB/CIMR-RGB/tests/Performance_Assesment/plotting_scripts/RSIR/ka_rsir_max_neighbours_10its.csv'
...
df_iter_25 = band[band['rsir_iteration'] == 10]
...
ax1.plot(df_iter_1['max_neighbours'], df_iter_1['mean_absolute_error'], label = 'rsir_iteration=1')
ax1.plot(df_iter_25['max_neighbours'], df_iter_25['mean_absolute_error'], label = 'rsir_iteration=10')
# ax1.plot(df_iter_50['max_neighbours'], df_iter_50['mean_absolute_error'], label = 'rsir_iteration=50')
...
plt.title('RSIR KA BAND max_neighbours vs MAE & MAPE (EASE2_G3km)', fontsize=16)
plt.show()