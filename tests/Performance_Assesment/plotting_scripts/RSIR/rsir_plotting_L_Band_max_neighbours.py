...
results_max_neighbours = '/home/beywood/ST/CIMR_RGB/CIMR-RGB/tests/Performance_Assesment/plotting_scripts/RSIR/RSIR_L_36km_max_neighbours.csv'
...
plt.title('RSIR L BAND max_neighbours vs MAE & MAPE (EASE2_G36km)', fontsize=16)
plt.show()