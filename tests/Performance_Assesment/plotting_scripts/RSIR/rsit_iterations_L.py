...
results_max_neighbours = '/home/beywood/ST/CIMR_RGB/CIMR-RGB/tests/Performance_Assesment/plotting_scripts/RSIR/RSIR_L_36km_rsir_iteration.csv'
...
df_mrf_3 = band[band['max_neighbours'] == 155]
