...
results_file_1 = '/tests/Performance_Assesment/plotting_scripts/BG/bg_smoothing/BG_C_9km_bg_smoothing.csv'
...
neigbours = band[band['max_neighbours'] == 6]
...
plt.title('BG C BAND bg_smoothing vs MAE & MAPE (EASE2_G9km)', fontsize=16)
plt.show()
