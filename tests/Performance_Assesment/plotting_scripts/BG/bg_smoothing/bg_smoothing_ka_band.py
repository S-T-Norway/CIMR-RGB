...
results_file_1 = '/tests/Performance_Assesment/plotting_scripts/BG/bg_smoothing/BG_KA_3km_bg_smoothing.csv'
...
neigbours = band[band['max_neighbours'] == 12]
df_1 = neigbours[band['MRF_grid_resolution'] == '1km']
df_3 = neigbours[band['MRF_grid_resolution'] == '3km']
df_9 = neigbours[band['MRF_grid_resolution'] == '9km']
...
plt.title('BG KA BAND bg_smoothing vs MAE & MAPE (EASE2_G3km)', fontsize=16)
plt.show()
