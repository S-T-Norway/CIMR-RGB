...
results_file = '/tests/Performance_Assesment/plotting_scripts/IDS/Soil_moisture/IDS_36km_max_neighbours.csv'
...
plt.suptitle('IDS max_neighbour vs MAE & MAPE (EASE2_G36km)', fontsize=16)
plt.show()