...
results_file = '/tests/Performance_Assesment/plotting_scripts/IDS/Soil_moisture/IDS_9km_max_neighbours.csv'
...
# plt.figure()
L_BAND = df[df['band'] == 'L']
L_BAND = L_BAND.sort_values(by='max_neighbours', ascending=True)
C_BAND = df[df['band'] == 'C']
X_BAND = df[df['band'] == 'X']
K_BAND = df[df['band'] == 'K']
...
plt.suptitle('IDS max_neighbour vs MAE & MAPE (EASE2_G9km)', fontsize=16)
plt.show()