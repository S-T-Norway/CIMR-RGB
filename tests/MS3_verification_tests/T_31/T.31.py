...
class AMSR2_comparison:
    ...
    def map_compare(self):
        ...
        fore_percent_diff = (fore_mean_diff / nanmean(self.ids_data['bt_h_10_BAND'])) * 100

        print(f"Average percentage difference for bt_h  for band 10: {fore_percent_diff}")
    ...
    def scatter_compare(self):
        ...
        x_h_10, y_h_10, m_h_10, b_h_10, y_fit_h_10, r_squared_10 = self.scatter_stats(x_10, y_10)

        x_23 = self.dib_data['bt_h_23_BAND'].flatten()
        y_23 = self.ids_data['bt_h_23_BAND'].flatten()
        x_h_23, y_h_23, m_h_23, b_h_23, y_fit_h_23, r_squared_23 = self.scatter_stats(x_23, y_23)

        x_89a = self.dib_data['bt_h_89a_BAND'].flatten()
        y_89a = self.ids_data['bt_h_89a_BAND'].flatten()
        x_h_89a, y_h_89a, m_h_89a, b_h_89a, y_fit_h_89a, r_squared_89a = self.scatter_stats(x_89a, y_89a)
