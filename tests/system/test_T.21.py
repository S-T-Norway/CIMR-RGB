...
#     """
#     Class for comparing remapped CIMR L-band simulated data using IDS and RSIR algorithms.
...
#         """
#         results = {}
#         diff = abs(self.rsir_data["bt_h"] - self.ids_data["bt_h"])
...
#         "output/MS3_verification_tests/T_21/CIMR_L1R_IDS_test.nc"
#     )
#     rsir_data = repo_root.joinpath(
#         "output/MS3_verification_tests/T_21/CIMR_L1R_RSIR_test.nc"
#     )
#     config_paths = {
#         "IDS": repo_root.joinpath("tests/MS3_verification_tests/T_21/T_21_IDS.xml"),
#         "RSIR": repo_root.joinpath("tests/MS3_verification_tests/T_21/T_21_RSIR.xml"),
#     }
...
#     comparison = CIMRComparison(ids_data, rsir_data)
