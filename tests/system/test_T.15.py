...
#     """
#     Class for comparing remapped SMAP L1b data using IDS and rSIR algorithms.
...
#     rsir_data_path : str
#         Path to the rSIR remapped netCDF file.
...
#     rsir_data : dict
#         Dictionary containing gridded variables from the rSIR data.
#     """
...
#                 var = array(l_band[bt][:])
#                 grid = full(
#                     (GRIDS["STEREO_N25km"]["n_rows"], GRIDS["STEREO_N25km"]["n_cols"]),
#                     nan,
#                 )
...
#         """
#         Calculate the differences between rSIR and IDS data.
...
#             - mean_diff : float
#                 Mean absolute difference between rSIR and IDS data.
#             - percent_diff : float
#                 Mean percentage difference relative to IDS data.
#         """
#         results = {}
#         for key in ["bt_h_fore", "bt_h_aft"]:
#             diff = abs(self.rsir_data[key] - self.ids_data[key])
...
#             Path to the rSIR remapped netCDF file.
#         - config_paths : dict
#             Dictionary containing configuration paths for IDS and rSIR tests.
#     """
#     repo_root = grasp_io.find_repo_root()
#     ids_data = repo_root.joinpath(
#         "output/MS3_verification_tests/T_15/SMAP_L1C_IDS_25km_test.nc"
#     )
#     rsir_data = repo_root.joinpath(
#         "output/MS3_verification_tests/T_15/SMAP_L1C_RSIR_25km_test.nc"
#     )
#     config_paths = {
#         "IDS": repo_root.joinpath("tests/MS3_verification_tests/T_15/T_15_IDS.xml"),
#         "rSIR": repo_root.joinpath("tests/MS3_verification_tests/T_15/T_15_RSIR.xml"),
#     }
#     return ids_data, rsir_data, config_paths


# def test_subprocess_execution(setup_paths):
#     """
#     Test the execution of the subprocess for IDS and rSIR.
...
#     Asserts
#     -------
#     Exit code of the subprocess is 0 for both IDS and rSIR.
#     """
...
#     """
#     ids_data, rsir_data, _ = setup_paths
#     comparison = SMAPComparison(ids_data, rsir_data)
...
@pytest.mark.parametrize("setup_paths", ["T_15"], indirect=True)
def test_T15_execution(setup_paths, run_subprocess):
    """
    Test the execution of the subprocess for the T_15 scenario.

    Parameters
    ----------
    setup_paths : dict
        Dictionary containing paths for the T_15 scenario, retrieved using the `setup_paths` fixture.
