...
PROJECTIONS = {
               ...
               'S':        "+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 "
                           "+datum=WGS84 +ellps=WGS84 +units=m +no_defs +type=crs", 
               'STEREO_N': "+proj=stere +lat_0=90 +lon_0=-45 +lat_ts=70 +k=1 +x_0=0 +y_0=0 "
                           "+datum=WGS84 +ellps=WGS84 +units=m +no_defs",
               'STEREO_S': "+proj=stere +lat_0=-90 +lat_ts=-70 +lon_0=0 +k=1 +x_0=0 +y_0=0 "
                           "+datum=WGS84 +ellps=WGS84 +units=m +no_defs",  
...
class GridGenerator:
    ...
    #    return xs, ys
        ...
        # TODO: This part of the code from the basemap python library: 
        # https://github.com/matplotlib/basemap/blob/develop/packages/basemap/src/mpl_toolkits/basemap/proj.py 
        # lines 350 - 353 
    ...
    def lonlat_to_xy_stereo(self, 
        ...
        if pole == 'N': 
            ...
            projection = PROJECTIONS['STEREO_S']
        else: 
            ValueError("Invalid value for pole. Must be 'N' or 'S'.")
    ...
    def lonlat_to_xy(self, 
        ...
        elif self.config.projection_definition == 'STEREO_N':

            x, y = self.lonlat_to_xy_stereo(lon = lon, lat = lat, pole = 'N') 

        elif self.config.projection_definition == 'STEREO_S':
